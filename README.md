...
1. Verify OpenCV release files exist for 2.4.8:
```
...
2. Check the OpenCV2 python bindings exist:
 >>> import cv2

```
3. Compile the package. Move the code directory into your `catkin_ws/src` and call `catkin_make` 
